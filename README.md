...
# Desktop-Calculator
Basic Calculator with basic arithmetic operations as well as square root, squaring, and exponentiation with x
...
## About the project
This application is a simple desktop calculator with basic arithmetic operations as well as square root, squaring, and exponentiation with x. Additionally, parentheses can be used, and a number or an entire expression can be negated. Additionally, calculations can be made with floating-point numbers. Division by zero is caught and highlighted as an error. Both the last numbers individually and the entire calculation can be cleared.
...
## Getting started
Conditions: To start the application, Java must be installed and the execution of JAR files should be enabled.
After cloning this repository, you can navigate to the "target" folder and run the command `java -jar desktop-calculator-_1.0.jar`. The calculator should now launch in its own window.
